            ...
            {navTabs.map((tab, index) => (
              <li key={tab.key}>
                <button
                  ...
                  className={`flex items-center space-x-2 pb-3 px-2 sm:px-4 text-sm font-medium transition-colors duration-200 border-b-2 -mb-2 focus:outline-none cursor-pointer ${
                    activeTab === tab.key
